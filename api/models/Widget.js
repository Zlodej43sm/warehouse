...
module.exports = {
  ...
  defaultContractTexts: {
    ...
    contr_item_2_1: "2.1 Сторони узгодили, що за взаємною згодою вартість товару, який Сторона2 передає у власність Стороні1 складає {PRICE} грн, в тому числі ПДФО {PDFO} грн (5%), військовий збір {MILITARY} грн (1,5%).",
