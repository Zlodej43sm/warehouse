...
module.exports = {
  ...
  attributes: {
    ...
    getContractTexts() {
      return this.contract || Widget.defaultContractTexts;
    },
    getCustomAppearance(){
      if (!this.content) {
  ...
  defaultContractTexts: {
    contr_item_0: "<center><b>ДОГОВІР</b></center>",
    contr_item_0_1: "<center><b>купівлі-продажу</b></center>",
    contr_item_0_2: "<center>м.{CITY}, {DAY} {MONTH} {YEAR}</center>",
    contr_item_0_3: "Фізична особа підприємець Копил Олександра Олегівна, що діє на підставі Виписки про державну реєстрацію № 20740000000028831 від 15.08.2016 (далі - Сторона 1)», яка діє від імені та за рахунок Фізична особа-підприємець Цьонь Сергій Анатолійович (далі - Довіритель) відповідно до Договору доручення №1 від «05» грудня 2016р., з однієї сторони, та Фізична особа - {NAME} , р. РНОКПП {SOCIAL_NUMBER} (далі Сторона2), з іншої сторони, в подальшому разом іменуються «Сторони», а кожна окремо «Сторона», уклали даний Договір купівлі-продажу (надалі іменується «Договір») про наступне:",
    contr_item_1: "<center><b>1. Предмет договору</b></center>",
    contr_item_1_1: "1.1 В порядку та на умовах, визначених цим Договором, Сторона2 зобов'язується передати у власність Довірителю (покупцеві) належне їй на праві власності наступне рухоме майно яке було у користуванні більше року: мобільний телефон {PRODUCT_NAME} IMEI (серійний номер) {PRODUCT_IMEI} (надалі іменується «товар»), а Сторона 1 зобов’язується прийняти такий товар та оплатити його.",
    contr_item_1_2: "1.2 Передача рухомого майна згідно з п.1.1. цього Договору здійснюється Стороною2 в місці укладення Договору Стороні1, яка діє як повірений Довірителя.",
    contr_item_1_3: "1.3 Сторона 2 зобов’язується передати товар Стороні1 під час підписання цього Договору, а Сторона1 зобов’язується прийняти товар та сплатити від імені Довірителя передбачену цим Договором ціну одночасно з отриманням майна від Сторони2.",
    contr_item_1_4: "1.4 Сторона2  підтверджує, що майно, визначене у п. 1.1.  цього Договору, на момент укладання цього Договору належить Стороні2 на праві власності, не знаходиться під забороною відчуження, арештом, не є предметом застави чи іншим засобом забезпечення виконання зобов’язань перед будь-якими фізичними або юридичними особами чи державою, а також не обтяжений будь-яким іншим чином, передбаченим чинним законодавством.",
    contr_item_2: "<center><b>2.Сума договору</b></center>",
    contr_item_2_1: "2.1 Сторони узгодили, що за взаємною згодою вартість товару, який Сторона2 передає у власність Стороні1 складає {PRICE_ESTIMATED} грн, в тому числі ПДФО {PDFO} грн (5%), військовий збір {MILITARY} грн (1,5%).",
    contr_item_3: "<center><b>3. Опис майна, упакування й маркування</b></center>",
    contr_item_3_1: "3.1 Опис майна (стан, упакування, комплектність тощо), яке Сторона2 передає у власність Стороні1: {DESCRIPTION}",
    contr_item_4: "<center><b>4. Приймання-передача товару</b></center>",
    contr_item_4_1: "4.1 Факт здійснення Сторонами операції купівлі-продажу підтверджується відповідним Актом приймання передачі товару, який укладається та підписується Сторонами в момент передачі майна.",
    contr_item_5: "<center><b>5. Персональні дані</b></center>",
    contr_item_5_1: "5.1 Сторона2 надає згоду використовувати персональні дані, які надані Стороні1 або Довірителю з метою реалізації державної політики в сфері захисту персональних даних, відповідно до Закону України «Про захист персональних даних» №2297-VI від 01.06.2010р. (надалі іменоване — Закон).",
    contr_item_5_2: "5.2 Сторона2 повністю розуміє, що вся надана інформація про неї, є персональними даними, тобто даними, які використовуються для ідентифікації Сторони2.  Сторона2 погоджується з тим, що такі дані зберігаються у Сторони1 або у Довірителя для подальшого використання відповідно до норм законодавства України та для реалізації ділових відносин між Сторонами. Персональні дані представника захищаються Конституцією України та Законом. Права Сторони2 регламентуються ст.8 Закону, а підпис на цьому документі означає однозначну згоду з вищевикладеним і підтвердженням того, що представник ознайомлений з вищезгаданими правами.",
    contr_item_0_4: "<center><b>РЕКВІЗИТИ ТА ПІДПИСИ СТОРІН:</b></center>",
    contr_item_0_5: "<b>СТОРОНА1:</b> Фізична особа-підприємець Копил Олександра Олегівна,01032, м. Київ, вул. Симона Петлюри, 22, р/р 26002052654922 в ПАТКБ «ПРИВАТБАНК», МФО 320649, Інд. Податковий 3218013749.",
    contr_item_0_6: "<b>Довіритель:</b> Фізична особа-підприємець Цьонь Сергій Анатолійович, 69063, м. Запоріжжя, вул. Кірова, 8, р/р 2600-2-70554801 в ПАТ «БАНК КРЕДИТ ДНІПРО», МФО 305749,Інд. Податковий 3233816016.",
    contr_item_0_7: "<b>СТОРОНА2:</b> {NAME}, РНОКПП {SOCIAL_NUMBER}, паспорт: {PASSPORT_SERIA} {PASSPORT_NUMBER} , виданий: {PASSPORT_GIVEN_BY}, місце реєстрації: {ADDRESS}, номер телефону {PHONE}",
    contr_item_0_8: "<table><tr><td>Від Сторони1: <div class='underlined width-20pc'></div><center>(підпис)</center></td><td>Від Сторони2: <div class='underlined width-20pc'></div><center>(підпис)</center></td></tr></table>"
  }
};
