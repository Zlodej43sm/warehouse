  ...
  $.fn.smartWizard = function(action) {
    ...
    return this.each(function(){
      ...
      function init(){
        ...
        obj.find('ul:first').addClass("anchor");
        allDivs.addClass("content");
        // Create Elements
        loader           = $('<div>Loading</div>').addClass("loader");
        elmActionBar     = $('<div></div>').addClass("actionBar");
        elmStepContainer = $('<div></div>').addClass("stepContainer");
        btNext           = $('<button>'+options.labelNext+'</button>').addClass("buttonNext btn color pull-right");
        btPrevious       = $('<button>'+options.labelPrevious+'</button>').addClass("buttonPrevious btn light pull-left");
        btFinish         = $('<button>'+options.labelFinish+'</button>').addClass("buttonFinish btn color pull-right");
